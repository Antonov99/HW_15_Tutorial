            ...
            while ((propertyName = reader.ReadPropertyName()) != null)
            {
                switch (propertyName)
                {
                    ...
                    case "enabled":
                        ...
                        break;
                    case "numTilesX":
                        instance.numTilesX = reader.Read<Int32>(ES3Type_int.Instance);
                        break;
                    case "numTilesY":
                        instance.numTilesY = reader.Read<Int32>(ES3Type_int.Instance);
                        break;
                    case "animation":
                    ...
                    case "frameOverTimeMultiplier":
                        instance.frameOverTimeMultiplier = reader.Read<Single>(ES3Type_float.Instance);
                        break;
                    case "startFrame":
                        instance.startFrame = reader.Read<ParticleSystem.MinMaxCurve>(ES3Type_MinMaxCurve.Instance);
                        break;
                    case "startFrameMultiplier":
                        instance.startFrameMultiplier = reader.Read<Single>(ES3Type_float.Instance);
                        break;
                    case "cycleCount":
                        instance.cycleCount = reader.Read<Int32>(ES3Type_int.Instance);
                        break;
                    case "rowIndex":
                        instance.rowIndex = reader.Read<Int32>(ES3Type_int.Instance);
                        break;
                    case "uvChannelMask":
